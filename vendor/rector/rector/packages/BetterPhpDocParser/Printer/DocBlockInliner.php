...
final class DocBlockInliner
{
    ...
    {
        $docContent = \RectorPrefix20211231\Nette\Utils\Strings::replace($docContent, self::NEWLINE_MIDDLE_DOC_REGEX, ' ');
        return \RectorPrefix20211231\Nette\Utils\Strings::replace($docContent, self::NEWLINE_CLOSING_DOC_REGEX, ' */');
    }
}
