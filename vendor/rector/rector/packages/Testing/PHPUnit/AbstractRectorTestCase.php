...
use RectorPrefix20211231\Symplify\EasyTesting\DataProvider\StaticFixtureFinder;
use RectorPrefix20211231\Symplify\EasyTesting\DataProvider\StaticFixtureUpdater;
...
abstract class AbstractRectorTestCase extends \Rector\Testing\PHPUnit\AbstractTestCase implements \Rector\Testing\Contract\RectorTestInterface
{
    ...
    protected function setUp() : void
    {
        ...
        $this->parameterProvider = $this->getService(\RectorPrefix20211231\Symplify\PackageBuilder\Parameter\ParameterProvider::class);
    ...
    {
        return \RectorPrefix20211231\Symplify\EasyTesting\DataProvider\StaticFixtureFinder::yieldDirectoryExclusively($directory, $suffix);
    }
    ...
    {
        $inputFileInfoAndExpectedFileInfo = \RectorPrefix20211231\Symplify\EasyTesting\StaticFixtureSplitter::splitFileInfoToLocalInputAndExpectedFileInfos($fixtureFileInfo);
    ...
    private function doTestFileMatchesExpectedContent(\Symplify\SmartFileSystem\SmartFileInfo $originalFileInfo, \Symplify\SmartFileSystem\SmartFileInfo $expectedFileInfo, \Symplify\SmartFileSystem\SmartFileInfo $fixtureFileInfo, bool $allowMatches = \true) : void
    {
        ...
        try {
            ...
            \RectorPrefix20211231\Symplify\EasyTesting\DataProvider\StaticFixtureUpdater::updateFixtureContent($originalFileInfo, $changedContent, $fixtureFileInfo);
