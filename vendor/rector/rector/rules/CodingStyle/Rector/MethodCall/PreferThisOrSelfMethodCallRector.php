...
, ['PHPUnit\\Framework\\TestCase' => \Rector\CodingStyle\Enum\PreferenceSelfThis::PREFER_SELF()])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20211231\Webmozart\Assert\Assert::isArray($typeToPreference);
        \RectorPrefix20211231\Webmozart\Assert\Assert::allString(\array_keys($typeToPreference));
        \RectorPrefix20211231\Webmozart\Assert\Assert::allIsAOf($typeToPreference, \Rector\CodingStyle\Enum\PreferenceSelfThis::class);
