...
final class FuncCallToStaticCallRector extends \Rector\Core\Rector\AbstractRector implements \Rector\Core\Contract\Rector\ConfigurableRectorInterface
{
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20211231\Webmozart\Assert\Assert::isArray($funcCallsToStaticCalls);
        \RectorPrefix20211231\Webmozart\Assert\Assert::allIsAOf($funcCallsToStaticCalls, \Rector\Transform\ValueObject\FuncCallToStaticCall::class);
