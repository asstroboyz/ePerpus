...
, ['SomeParent' => 'SomeInterface'])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20211231\Webmozart\Assert\Assert::isArray($interfaceByParent);
        \RectorPrefix20211231\Webmozart\Assert\Assert::allString(\array_keys($interfaceByParent));
        \RectorPrefix20211231\Webmozart\Assert\Assert::allString($interfaceByParent);
