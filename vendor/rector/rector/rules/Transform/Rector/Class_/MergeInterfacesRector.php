...
, ['SomeOldInterface' => 'SomeInterface'])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20211231\Webmozart\Assert\Assert::isArray($oldToNewInterfaces);
        \RectorPrefix20211231\Webmozart\Assert\Assert::allString(\array_keys($oldToNewInterfaces));
        \RectorPrefix20211231\Webmozart\Assert\Assert::allString($oldToNewInterfaces);
