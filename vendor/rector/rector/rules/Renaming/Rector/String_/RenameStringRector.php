...
, ['ROLE_PREVIOUS_ADMIN' => 'IS_IMPERSONATOR'])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20211231\Webmozart\Assert\Assert::isArray($stringChanges);
        \RectorPrefix20211231\Webmozart\Assert\Assert::allString(\array_keys($stringChanges));
        \RectorPrefix20211231\Webmozart\Assert\Assert::allString($stringChanges);
