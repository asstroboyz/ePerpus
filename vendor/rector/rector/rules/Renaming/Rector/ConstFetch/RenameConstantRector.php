...
, ['MYSQL_ASSOC' => 'MYSQLI_ASSOC', 'OLD_CONSTANT' => 'NEW_CONSTANT'])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20211231\Webmozart\Assert\Assert::allString(\array_keys($oldToNewConstants));
        \RectorPrefix20211231\Webmozart\Assert\Assert::allString($oldToNewConstants);
