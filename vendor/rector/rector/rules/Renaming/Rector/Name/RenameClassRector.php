...
, ['App\\SomeOldClass' => 'App\\SomeNewClass'])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20211231\Webmozart\Assert\Assert::isArray($oldToNewClasses);
        \RectorPrefix20211231\Webmozart\Assert\Assert::allString($oldToNewClasses);
    ...
    {
        \RectorPrefix20211231\Webmozart\Assert\Assert::allString(\array_keys($oldToNewClasses));
        \RectorPrefix20211231\Webmozart\Assert\Assert::allString($oldToNewClasses);
