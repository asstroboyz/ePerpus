...
, ['ParentClassWithNewConstructor' => \Rector\Core\ValueObject\MethodName::CONSTRUCT])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20211231\Webmozart\Assert\Assert::allString(\array_keys($methodsByParentTypes));
        \RectorPrefix20211231\Webmozart\Assert\Assert::allString($methodsByParentTypes);
