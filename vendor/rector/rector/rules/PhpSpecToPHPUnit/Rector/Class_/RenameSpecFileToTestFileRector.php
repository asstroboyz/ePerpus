...
CODE_SAMPLE
    ...
    {
        // suffix
        $newRealPath = \RectorPrefix20211231\Nette\Utils\Strings::replace($oldRealPath, self::SPEC_SUFFIX_REGEX, 'Test.php');
        // directory
        return \RectorPrefix20211231\Nette\Utils\Strings::replace($newRealPath, self::SPEC_REGEX, '/tests/');
    }
}
