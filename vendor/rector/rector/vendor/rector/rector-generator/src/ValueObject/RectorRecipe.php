...
final class RectorRecipe
{
    ...
    {
        $this->category = (string) \RectorPrefix20211231\Nette\Utils\Strings::after($nodeTypes[0], '\\', -1);
    }
    ...
    private function detectRectorRepository() : bool
    {
        ...
        foreach ($possibleComposerJsonFilePaths as $possibleComposerJsonFilePath) {
            ...
            $composerJson = \RectorPrefix20211231\Nette\Utils\Json::decode($composerJsonContent, \RectorPrefix20211231\Nette\Utils\Json::FORCE_ARRAY);
