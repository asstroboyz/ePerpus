...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        if (\substr_compare($shortClassName, 'Type', -\strlen('Type')) === 0) {
            $shortClassName = (string) \RectorPrefix20211231\Nette\Utils\Strings::before($shortClassName, 'Type');
        }
        $shortClassNameUnicodeString = new \RectorPrefix20211231\Symfony\Component\String\UnicodeString($shortClassName);
