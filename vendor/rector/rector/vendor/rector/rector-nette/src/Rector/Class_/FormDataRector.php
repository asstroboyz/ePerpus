...
, [self::FORM_DATA_CLASS_PARENT => '', self::FORM_DATA_CLASS_TRAITS => []])]);
    ...
    public function configure(array $configuration) : void
    {
        if (isset($configuration[self::FORM_DATA_CLASS_PARENT])) {
            ...
            \RectorPrefix20211231\Webmozart\Assert\Assert::string($formDataClassParent);
        ...
        if (isset($configuration[self::FORM_DATA_CLASS_TRAITS])) {
            ...
            \RectorPrefix20211231\Webmozart\Assert\Assert::isArray($formDataClassTraits);
            \RectorPrefix20211231\Webmozart\Assert\Assert::allString($formDataClassTraits);
