...
final class NetteControlNaming
{
    ...
    {
        $variableNameUnicodeString = new \RectorPrefix20211231\Symfony\Component\String\UnicodeString($shortName);
    ...
    {
        $shortNameUnicodeString = new \RectorPrefix20211231\Symfony\Component\String\UnicodeString($shortName);
