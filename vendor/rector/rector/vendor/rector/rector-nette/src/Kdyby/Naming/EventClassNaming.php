...
final class EventClassNaming
{
    ...
    {
        $namespaceAbove = \RectorPrefix20211231\Nette\Utils\Strings::before($orinalClassName, '\\', -1);
    ...
    private function createShortEventClassNameFromClassAndProperty(string $class, string $property) : string
    {
        ...
        // "onMagic" => "Magic"
        $shortPropertyName = \RectorPrefix20211231\Nette\Utils\Strings::substring($property, \strlen('on'));
