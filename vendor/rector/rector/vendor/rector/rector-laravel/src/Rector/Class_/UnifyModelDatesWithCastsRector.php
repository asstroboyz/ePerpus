...
CODE_SAMPLE
    ...
    public function refactor(\PhpParser\Node $node) : ?\PhpParser\Node
    {
        ...
        \RectorPrefix20211231\Webmozart\Assert\Assert::allString($missingDates);
    ...
    {
        $propertyBuilder = new \RectorPrefix20211231\Symplify\Astral\ValueObject\NodeBuilder\PropertyBuilder('casts');
