...
, [self::ALIASES_TO_NAMESPACES => ['App' => 'App\\Entity']])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20211231\Webmozart\Assert\Assert::isArray($aliasesToNamespaces);
        \RectorPrefix20211231\Webmozart\Assert\Assert::allString(\array_keys($aliasesToNamespaces));
        \RectorPrefix20211231\Webmozart\Assert\Assert::allString($aliasesToNamespaces);
