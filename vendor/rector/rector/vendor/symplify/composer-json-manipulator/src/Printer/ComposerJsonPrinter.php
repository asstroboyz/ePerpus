...
namespace RectorPrefix20211231\Symplify\ComposerJsonManipulator\Printer;
...
final class ComposerJsonPrinter
{
    ...
    public function printToString(\RectorPrefix20211231\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson) : string
    {
     ...
     */
    public function print(\RectorPrefix20211231\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson, $targetFile) : string
    {
