...
namespace RectorPrefix20211231\Symplify\Astral\PhpParser;
...
{
    public function create() : \RectorPrefix20211231\Symplify\Astral\PhpParser\SmartPhpParser
    {
        $nativePhpParser = $this->createNativePhpParser();
        $cachedParser = $this->createPHPStanParser($nativePhpParser);
        return new \RectorPrefix20211231\Symplify\Astral\PhpParser\SmartPhpParser($cachedParser);
    }
