...
use RectorPrefix20211231\Symplify\Skipper\SkipCriteriaResolver\SkippedClassAndCodesResolver;
use Symplify\SmartFileSystem\SmartFileInfo;
/**
 * Matching class and code, e.g. App\Category\ArraySniff.SomeCode
 */
final class ClassAndCodeSkipVoter implements \RectorPrefix20211231\Symplify\Skipper\Contract\SkipVoterInterface
{
    /**
    ...
    public function __construct(\RectorPrefix20211231\Symplify\Skipper\SkipCriteriaResolver\SkippedClassAndCodesResolver $skippedClassAndCodesResolver, \RectorPrefix20211231\Symplify\Skipper\Matcher\FileInfoMatcher $fileInfoMatcher)
    {
