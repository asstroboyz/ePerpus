 ...
 */
class LazyPromise implements \RectorPrefix20211231\React\Promise\ExtendedPromiseInterface, \RectorPrefix20211231\React\Promise\CancellablePromiseInterface
{
    private $factory;
    private $promise;
    ...
    public function promise()
    {
        if (null === $this->promise) {
            try {
                ...
                $this->promise = new \RectorPrefix20211231\React\Promise\RejectedPromise($exception);
