...
class Promise implements \RectorPrefix20211231\React\Promise\ExtendedPromiseInterface, \RectorPrefix20211231\React\Promise\CancellablePromiseInterface
{
    private $canceller;
    private $result;
    private $handlers = [];
    ...
    public function done(callable $onFulfilled = null, callable $onRejected = null, callable $onProgress = null)
    {
        ...
        $this->handlers[] = static function (\RectorPrefix20211231\React\Promise\ExtendedPromiseInterface $promise) use($onFulfilled, $onRejected) {
    ...
    public function otherwise(callable $onRejected)
    {
        return $this->then(null, static function ($reason) use($onRejected) {
            if (!_checkTypehint($onRejected, $reason)) {
                return new \RectorPrefix20211231\React\Promise\RejectedPromise($reason);
            }
    ...
    private function resolver(callable $onFulfilled = null, callable $onRejected = null, callable $onProgress = null)
    {
        return function ($resolve, $reject, $notify) use($onFulfilled, $onRejected, $onProgress) {
            ...
            $this->handlers[] = static function (\RectorPrefix20211231\React\Promise\ExtendedPromiseInterface $promise) use($onFulfilled, $onRejected, $resolve, $reject, $progressHandler) {
    ...
    private function settle(\RectorPrefix20211231\React\Promise\ExtendedPromiseInterface $promise)
    {
        $promise = $this->unwrap($promise);
        if ($promise === $this) {
            $promise = new \RectorPrefix20211231\React\Promise\RejectedPromise(new \LogicException('Cannot resolve a promise with itself.'));
        }
    ...
    {
        if ($promise instanceof \RectorPrefix20211231\React\Promise\LazyPromise) {
