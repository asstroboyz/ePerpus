...
namespace RectorPrefix20211231\React\Promise\Timer;
 ...
 */
function timeout(\RectorPrefix20211231\React\Promise\PromiseInterface $promise, $time, \RectorPrefix20211231\React\EventLoop\LoopInterface $loop = null)
{
    ...
    if ($loop === null) {
        $loop = \RectorPrefix20211231\React\EventLoop\Loop::get();
    }
    return new \RectorPrefix20211231\React\Promise\Promise(function ($resolve, $reject) use($loop, $time, $promise) {
        $timer = null;
        ...
        $timer = $loop->addTimer($time, function () use($time, &$promise, $reject) {
            $reject(new \RectorPrefix20211231\React\Promise\Timer\TimeoutException($time, 'Timed out after ' . $time . ' seconds'));
 ...
 */
function sleep($time, \RectorPrefix20211231\React\EventLoop\LoopInterface $loop = null)
{
    if ($loop === null) {
        $loop = \RectorPrefix20211231\React\EventLoop\Loop::get();
    }
    $timer = null;
    return new \RectorPrefix20211231\React\Promise\Promise(function ($resolve) use($loop, $time, &$timer) {
 ...
 * @see sleep()
 */
function resolve($time, \RectorPrefix20211231\React\EventLoop\LoopInterface $loop = null)
{
 ...
 * @see sleep()
 */
function reject($time, \RectorPrefix20211231\React\EventLoop\LoopInterface $loop = null)
{
    return \sleep($time, $loop)->then(function () use($time) {
        throw new \RectorPrefix20211231\React\Promise\Timer\TimeoutException($time, 'Timer expired after ' . $time . ' seconds');
    });
}
