 ...
 */
class LimitingServer extends \RectorPrefix20211231\Evenement\EventEmitter implements \RectorPrefix20211231\React\Socket\ServerInterface
{
     ...
     */
    public function __construct(\RectorPrefix20211231\React\Socket\ServerInterface $server, $connectionLimit, $pauseOnLimit = \false)
    {
        $this->server = $server;
    ...
    /** @internal */
    public function handleDisconnection(\RectorPrefix20211231\React\Socket\ConnectionInterface $connection)
    {
