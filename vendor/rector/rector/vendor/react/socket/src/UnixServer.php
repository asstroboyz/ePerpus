 ...
 */
final class UnixServer extends \RectorPrefix20211231\Evenement\EventEmitter implements \RectorPrefix20211231\React\Socket\ServerInterface
{
    private $master;
    private $loop;
     ...
     */
    public function __construct($path, \RectorPrefix20211231\React\EventLoop\LoopInterface $loop = null, array $context = array())
    {
        ...
        if (\false === $this->master) {
            ...
            throw new \RuntimeException('Failed to listen on Unix domain socket "' . $path . '": ' . $errstr . \RectorPrefix20211231\React\Socket\SocketServer::errconst($errno), $errno);
        }
