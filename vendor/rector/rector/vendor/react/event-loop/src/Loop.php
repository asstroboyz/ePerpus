...
final class Loop
{
    ...
    {
        if (self::$instance instanceof \RectorPrefix20211231\React\EventLoop\LoopInterface) {
            return self::$instance;
        }
        self::$instance = $loop = \RectorPrefix20211231\React\EventLoop\Factory::create();
     ...
     * @return void
     */
    public static function set(\RectorPrefix20211231\React\EventLoop\LoopInterface $loop)
    {
        self::$instance = $loop;
    }
    /**
     ...
     */
    public static function cancelTimer(\RectorPrefix20211231\React\EventLoop\TimerInterface $timer)
    {
