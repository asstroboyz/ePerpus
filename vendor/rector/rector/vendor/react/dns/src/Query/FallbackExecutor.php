...
final class FallbackExecutor implements \RectorPrefix20211231\React\Dns\Query\ExecutorInterface
{
    private $executor;
    private $fallback;
    public function __construct(\RectorPrefix20211231\React\Dns\Query\ExecutorInterface $executor, \RectorPrefix20211231\React\Dns\Query\ExecutorInterface $fallback)
    {
    ...
    public function query(\RectorPrefix20211231\React\Dns\Query\Query $query)
    {
        ...
        return new \RectorPrefix20211231\React\Promise\Promise(function ($resolve, $reject) use(&$promise, $fallback, $query, &$cancelled) {
