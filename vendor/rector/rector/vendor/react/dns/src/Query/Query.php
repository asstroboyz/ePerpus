...
final class Query
{
    ...
    {
        $class = $this->class !== \RectorPrefix20211231\React\Dns\Model\Message::CLASS_IN ? 'CLASS' . $this->class . ' ' : '';
        $type = 'TYPE' . $this->type;
        $ref = new \ReflectionClass('RectorPrefix20211231\\React\\Dns\\Model\\Message');
