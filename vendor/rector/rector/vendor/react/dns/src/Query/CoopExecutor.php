 ...
 * ```
 */
final class CoopExecutor implements \RectorPrefix20211231\React\Dns\Query\ExecutorInterface
{
    private $executor;
    private $pending = array();
    private $counts = array();
    public function __construct(\RectorPrefix20211231\React\Dns\Query\ExecutorInterface $base)
    {
        $this->executor = $base;
    }
    ...
    private function serializeQueryToIdentity(\RectorPrefix20211231\React\Dns\Query\Query $query)
    {
