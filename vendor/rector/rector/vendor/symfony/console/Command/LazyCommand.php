 ...
 */
final class LazyCommand extends \RectorPrefix20211231\Symfony\Component\Console\Command\Command
{
    private $command;
    /**
     * @var bool|null
    ...
    public function setApplication(\RectorPrefix20211231\Symfony\Component\Console\Application $application = null) : void
    {
    ...
    public function setHelperSet(\RectorPrefix20211231\Symfony\Component\Console\Helper\HelperSet $helperSet) : void
    {
        if ($this->command instanceof parent) {
