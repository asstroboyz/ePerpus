...
use RectorPrefix20211231\Symfony\Component\Console\Formatter\NullOutputFormatter;
 ...
 */
class NullOutput implements \RectorPrefix20211231\Symfony\Component\Console\Output\OutputInterface
{
    private $formatter;
    /**
     * {@inheritdoc}
    ...
    public function getFormatter() : \RectorPrefix20211231\Symfony\Component\Console\Formatter\OutputFormatterInterface
    {
        ...
        return $this->formatter = $this->formatter ?? new \RectorPrefix20211231\Symfony\Component\Console\Formatter\NullOutputFormatter();
    }
    /**
     * {@inheritdoc}
     */
