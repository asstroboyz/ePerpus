...
class Exporter
{
    ...
    public static function prepare($values, $objectsPool, &$refsPool, &$objectsCount, &$valuesAreStatic) : array
    {
        ...
        foreach ($values as $k => $value) {
            if (\is_resource($value)) {
                throw new \RectorPrefix20211231\Symfony\Component\VarExporter\Exception\NotInstantiableTypeException(\get_resource_type($value) . ' resource');
            }
            $refs[$k] = $objectsPool;
            if ($isRef = !($valueIsStatic = $values[$k] !== $objectsPool)) {
                ...
                if ($value instanceof \RectorPrefix20211231\Symfony\Component\VarExporter\Internal\Reference && 0 > $value->id) {
                    $valuesAreStatic = \false;
                    ++$value->count;
                    continue;
                }
                $refsPool[] = [&$refs[$k], $value, &$value];
                $refs[$k] = $values[$k] = new \RectorPrefix20211231\Symfony\Component\VarExporter\Internal\Reference(-\count($refsPool), $value);
            }
            if (\is_array($value)) {
                if ($value) {
                ...
                goto handle_value;
            } elseif (!\is_object($value) || $value instanceof \RectorPrefix20211231\UnitEnum) {
                goto handle_value;
            }
            $valueIsStatic = \false;
            if (isset($objectsPool[$value])) {
                ++$objectsCount;
                $value = new \RectorPrefix20211231\Symfony\Component\VarExporter\Internal\Reference($objectsPool[$value][0]);
                goto handle_value;
            }
            ...
            $properties = [];
            $sleep = null;
            $proto = \RectorPrefix20211231\Symfony\Component\VarExporter\Internal\Registry::$prototypes[$class];
            if (($value instanceof \ArrayIterator || $value instanceof \ArrayObject) && null !== $proto) {
                ...
                \RectorPrefix20211231\Symfony\Component\VarExporter\Internal\Registry::getClassReflector($class, \RectorPrefix20211231\Symfony\Component\VarExporter\Internal\Registry::$instantiableWithoutConstructor[$class], \RectorPrefix20211231\Symfony\Component\VarExporter\Internal\Registry::$cloneable[$class]);
            } elseif ($value instanceof \SplObjectStorage && \RectorPrefix20211231\Symfony\Component\VarExporter\Internal\Registry::$cloneable[$class] && null !== $proto) {
                ...
                $value = new \RectorPrefix20211231\Symfony\Component\VarExporter\Internal\Reference($id);
                goto handle_value;
            } else {
    ...
    {
        switch (\true) {
            case \is_int($value) || \is_float($value) || $value instanceof \RectorPrefix20211231\UnitEnum:
        ...
        if ($value instanceof \RectorPrefix20211231\Symfony\Component\VarExporter\Internal\Reference) {
            if (0 <= $value->id) {
                return '$o[' . $value->id . ']';
            }
            if (!$value->count) {
        ...
        if ($value instanceof \RectorPrefix20211231\Symfony\Component\VarExporter\Internal\Values) {
            $code = $subIndent . "\$r = [],\n";
        ...
        if ($value instanceof \RectorPrefix20211231\Symfony\Component\VarExporter\Internal\Registry) {
            return self::exportRegistry($value, $indent, $subIndent);
        }
        if ($value instanceof \RectorPrefix20211231\Symfony\Component\VarExporter\Internal\Hydrator) {
    ...
    private static function exportRegistry(\RectorPrefix20211231\Symfony\Component\VarExporter\Internal\Registry $value, string $indent, string $subIndent) : string
    {
        $code = '';
        $serializables = [];
        $seen = [];
        $prototypesAccess = 0;
        $factoriesAccess = 0;
        $r = '\\' . \RectorPrefix20211231\Symfony\Component\VarExporter\Internal\Registry::class;
        $j = -1;
        foreach ($value->classes as $k => $class) {
            ...
            if (!\RectorPrefix20211231\Symfony\Component\VarExporter\Internal\Registry::$instantiableWithoutConstructor[$class]) {
    ...
    private static function exportHydrator(\RectorPrefix20211231\Symfony\Component\VarExporter\Internal\Hydrator $value, string $indent, string $subIndent) : string
    {
        $code = '';
    ...
    private static function getArrayObjectProperties($value, $proto) : array
    {
        ...
        $reflector = \RectorPrefix20211231\Symfony\Component\VarExporter\Internal\Registry::$reflectors[$reflector] ?? \RectorPrefix20211231\Symfony\Component\VarExporter\Internal\Registry::getClassReflector($reflector);
