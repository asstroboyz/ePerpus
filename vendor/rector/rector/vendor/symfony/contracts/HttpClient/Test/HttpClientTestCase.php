...
use RectorPrefix20211231\Symfony\Contracts\HttpClient\Exception\ClientExceptionInterface;
use RectorPrefix20211231\Symfony\Contracts\HttpClient\Exception\RedirectionExceptionInterface;
use RectorPrefix20211231\Symfony\Contracts\HttpClient\Exception\TimeoutExceptionInterface;
use RectorPrefix20211231\Symfony\Contracts\HttpClient\Exception\TransportExceptionInterface;
use RectorPrefix20211231\Symfony\Contracts\HttpClient\HttpClientInterface;
/**
 * A reference test suite for HttpClientInterface implementations.
 */
abstract class HttpClientTestCase extends \RectorPrefix20211231\PHPUnit\Framework\TestCase
{
    public static function setUpBeforeClass() : void
    {
        \RectorPrefix20211231\Symfony\Contracts\HttpClient\Test\TestHttpServer::start();
    }
    protected abstract function getHttpClient(string $testCase) : \RectorPrefix20211231\Symfony\Contracts\HttpClient\HttpClientInterface;
    public function testGetRequest()
    {
        ...
        $this->expectException(\RectorPrefix20211231\Symfony\Contracts\HttpClient\Exception\TransportExceptionInterface::class);
        $response->getContent();
    }
    ...
    public function testClientError()
    {
        ...
        try {
            $response->getHeaders();
            $this->fail(\RectorPrefix20211231\Symfony\Contracts\HttpClient\Exception\ClientExceptionInterface::class . ' expected');
        } catch (\RectorPrefix20211231\Symfony\Contracts\HttpClient\Exception\ClientExceptionInterface $e) {
        }
        try {
            $response->getContent();
            $this->fail(\RectorPrefix20211231\Symfony\Contracts\HttpClient\Exception\ClientExceptionInterface::class . ' expected');
    ...
    public function testDnsError()
    {
        ...
        try {
            ...
            $this->fail(\RectorPrefix20211231\Symfony\Contracts\HttpClient\Exception\TransportExceptionInterface::class . ' expected');
        } catch (\RectorPrefix20211231\Symfony\Contracts\HttpClient\Exception\TransportExceptionInterface $e) {
            $this->addToAssertionCount(1);
        }
        try {
            $response->getStatusCode();
            $this->fail(\RectorPrefix20211231\Symfony\Contracts\HttpClient\Exception\TransportExceptionInterface::class . ' still expected');
        } catch (\RectorPrefix20211231\Symfony\Contracts\HttpClient\Exception\TransportExceptionInterface $e) {
            $this->addToAssertionCount(1);
        }
        $response = $client->request('GET', 'http://localhost:8057/301/bad-tld');
    ...
    public function testInvalidRedirect()
    {
        ...
        $this->assertNull($response->getInfo('redirect_url'));
        $this->expectException(\RectorPrefix20211231\Symfony\Contracts\HttpClient\Exception\RedirectionExceptionInterface::class);
        $response->getHeaders();
    }
    ...
    public function testMaxRedirects()
    {
        ...
        try {
            $response->getHeaders();
            $this->fail(\RectorPrefix20211231\Symfony\Contracts\HttpClient\Exception\RedirectionExceptionInterface::class . ' expected');
        } catch (\RectorPrefix20211231\Symfony\Contracts\HttpClient\Exception\RedirectionExceptionInterface $e) {
        }
        $this->assertSame(302, $response->getStatusCode());
    ...
    public function testTimeoutIsNotAFatalError()
    {
        ...
        try {
            $response->getContent();
            $this->fail(\RectorPrefix20211231\Symfony\Contracts\HttpClient\Exception\TimeoutExceptionInterface::class . ' expected');
        } catch (\RectorPrefix20211231\Symfony\Contracts\HttpClient\Exception\TimeoutExceptionInterface $e) {
        }
        for ($i = 0; $i < 10; ++$i) {
            try {
    ...
    {
        $p1 = \RectorPrefix20211231\Symfony\Contracts\HttpClient\Test\TestHttpServer::start(8067);
        $p2 = \RectorPrefix20211231\Symfony\Contracts\HttpClient\Test\TestHttpServer::start(8077);
        $client = $this->getHttpClient(__FUNCTION__);
