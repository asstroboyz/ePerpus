...
use RectorPrefix20211231\Symfony\Component\Translation\Exception\InvalidArgumentException;
/**
...
EOF;
        ...
        if (!isset($standardRules[$position])) {
            ...
            if (\class_exists(\RectorPrefix20211231\Symfony\Component\Translation\Exception\InvalidArgumentException::class)) {
                throw new \RectorPrefix20211231\Symfony\Component\Translation\Exception\InvalidArgumentException($message);
            }
