 ...
 */
class ReplaceAliasByActualDefinitionPass extends \RectorPrefix20211231\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
     ...
     * @return $this
     */
    public function setAutoAliasServicePass(\RectorPrefix20211231\Symfony\Component\DependencyInjection\Compiler\AutoAliasServicePass $autoAliasServicePass) : self
    {
        ...
        foreach ($container->getAliases() as $definitionId => $target) {
            ...
            try {
                ...
                if ('' !== $e->getId() && '@' === $e->getId()[0]) {
                    throw new \RectorPrefix20211231\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException($e->getId(), $e->getSourceId(), null, [\substr($e->getId(), 1)]);
                }
                throw $e;
            }
    ...
    {
        if ($value instanceof \RectorPrefix20211231\Symfony\Component\DependencyInjection\Reference && isset($this->replacements[$referenceId = (string) $value])) {
            // Perform the replacement
            $newId = $this->replacements[$referenceId];
            $value = new \RectorPrefix20211231\Symfony\Component\DependencyInjection\Reference($newId, $value->getInvalidBehavior());
