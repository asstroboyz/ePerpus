 ...
 */
final class AttributeAutoconfigurationPass extends \RectorPrefix20211231\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    ...
    public function process(\RectorPrefix20211231\Symfony\Component\DependencyInjection\ContainerBuilder $container) : void
    {
    ...
    {
        if (!$value instanceof \RectorPrefix20211231\Symfony\Component\DependencyInjection\Definition || !$value->isAutoconfigured() || $value->isAbstract() || $value->hasTag('container.ignore_attributes') || !($classReflector = $this->container->getReflectionClass($value->getClass(), \false))) {
            return parent::processValue($value, $isRoot);
        }
        $instanceof = $value->getInstanceofConditionals();
        $conditionals = $instanceof[$classReflector->getName()] ?? new \RectorPrefix20211231\Symfony\Component\DependencyInjection\ChildDefinition('');
        ...
        if (!isset($instanceof[$classReflector->getName()]) && new \RectorPrefix20211231\Symfony\Component\DependencyInjection\ChildDefinition('') != $conditionals) {
