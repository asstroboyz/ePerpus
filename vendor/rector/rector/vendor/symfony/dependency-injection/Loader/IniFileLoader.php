 ...
 */
class IniFileLoader extends \RectorPrefix20211231\Symfony\Component\DependencyInjection\Loader\FileLoader
{
    /**
     * {@inheritdoc}
    ...
    public function load($resource, $type = null)
    {
        ...
        if (\false === $result || [] === $result) {
            throw new \RectorPrefix20211231\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException(\sprintf('The "%s" file is not valid.', $resource));
        }
        // real raw parsing
    ...
    private function phpize(string $value)
    {
        ...
        switch (\true) {
            ...
            default:
                return \RectorPrefix20211231\Symfony\Component\Config\Util\XmlUtils::phpize($value);
        }
    }
}
