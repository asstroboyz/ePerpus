...
trait ParentTrait
{
    ...
    {
        if (!$this->allowParent) {
            throw new \RectorPrefix20211231\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException(\sprintf('A parent cannot be defined when either "_instanceof" or "_defaults" are also defined for service prototype "%s".', $this->id));
        }
        if ($this->definition instanceof \RectorPrefix20211231\Symfony\Component\DependencyInjection\ChildDefinition) {
