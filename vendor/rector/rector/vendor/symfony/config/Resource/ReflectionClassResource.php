...
use RectorPrefix20211231\Symfony\Component\Messenger\Handler\MessageSubscriberInterface;
 ...
 * @final
 */
class ReflectionClassResource implements \RectorPrefix20211231\Symfony\Component\Config\Resource\SelfCheckingResourceInterface
{
    private $files = [];
    private $className;
    ...
    private function generateSignature(\ReflectionClass $class) : iterable
    {
        ...
        if (\interface_exists(\RectorPrefix20211231\Symfony\Component\EventDispatcher\EventSubscriberInterface::class, \false) && $class->isSubclassOf(\RectorPrefix20211231\Symfony\Component\EventDispatcher\EventSubscriberInterface::class)) {
            (yield \RectorPrefix20211231\Symfony\Component\EventDispatcher\EventSubscriberInterface::class);
            (yield \print_r($class->name::getSubscribedEvents(), \true));
        }
        if (\interface_exists(\RectorPrefix20211231\Symfony\Component\Messenger\Handler\MessageSubscriberInterface::class, \false) && $class->isSubclassOf(\RectorPrefix20211231\Symfony\Component\Messenger\Handler\MessageSubscriberInterface::class)) {
            (yield \RectorPrefix20211231\Symfony\Component\Messenger\Handler\MessageSubscriberInterface::class);
            foreach ($class->name::getHandledMessages() as $key => $value) {
                (yield $key . \print_r($value, \true));
            }
        }
        if (\interface_exists(\RectorPrefix20211231\Symfony\Contracts\Service\ServiceSubscriberInterface::class, \false) && $class->isSubclassOf(\RectorPrefix20211231\Symfony\Contracts\Service\ServiceSubscriberInterface::class)) {
            (yield \RectorPrefix20211231\Symfony\Contracts\Service\ServiceSubscriberInterface::class);
