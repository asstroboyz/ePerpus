 ...
 */
class ResourceCheckerConfigCache implements \RectorPrefix20211231\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write(string $content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \RectorPrefix20211231\Symfony\Component\Filesystem\Filesystem();
