...
, [self::OLD_TO_NEW_FILE_LOCATIONS => ['add.gif' => 'EXT:backend/Resources/Public/Images/FormFieldWizard/wizard_add.gif']])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20211231\Webmozart\Assert\Assert::isArray($oldToNewFileLocations);
        \RectorPrefix20211231\Webmozart\Assert\Assert::allString(\array_keys($oldToNewFileLocations));
        \RectorPrefix20211231\Webmozart\Assert\Assert::allString($oldToNewFileLocations);
