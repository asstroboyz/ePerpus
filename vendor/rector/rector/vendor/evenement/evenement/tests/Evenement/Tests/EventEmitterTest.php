...
class EventEmitterTest extends \RectorPrefix20211231\PHPUnit\Framework\TestCase
{
    private $emitter;
    public function setUp()
    {
        $this->emitter = new \RectorPrefix20211231\Evenement\EventEmitter();
    }
    ...
    {
        $listener = new \RectorPrefix20211231\Evenement\Tests\Listener();
        $this->emitter->on('foo', [$listener, 'onFoo']);
    }
    public function testAddListenerWithStaticMethod()
    {
        $this->emitter->on('bar', ['RectorPrefix20211231\\Evenement\\Tests\\Listener', 'onBar']);
    }
    ...
    public function testCallablesStaticClass()
    {
        ...
        $this->emitter->emit('foo', ['bar']);
        self::assertSame(['bar'], \RectorPrefix20211231\Evenement\Tests\Listener::getStaticData());
    }
    public function testCallablesFunction()
    {
        $this->emitter->on('foo', 'RectorPrefix20211231\\Evenement\\Tests\\setGlobalTestData');
        $this->emitter->emit('foo', ['bar']);
