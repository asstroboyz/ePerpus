...
use RectorPrefix20211231\Composer\Composer;
use RectorPrefix20211231\Composer\DependencyResolver\Operation\InstallOperation;
use RectorPrefix20211231\Composer\DependencyResolver\Operation\UninstallOperation;
use RectorPrefix20211231\Composer\DependencyResolver\Operation\UpdateOperation;
use RectorPrefix20211231\Composer\DependencyResolver\Operation\OperationInterface;
use RectorPrefix20211231\Composer\EventDispatcher\EventSubscriberInterface;
use RectorPrefix20211231\Composer\IO\IOInterface;
use RectorPrefix20211231\Composer\Package\AliasPackage;
use RectorPrefix20211231\Composer\Package\PackageInterface;
use RectorPrefix20211231\Composer\Plugin\PluginInterface;
use RectorPrefix20211231\Composer\Installer\PackageEvents;
use RectorPrefix20211231\Composer\Script\Event;
use RectorPrefix20211231\Composer\Script\ScriptEvents;
use RectorPrefix20211231\Composer\Installer\PackageEvent;
use RectorPrefix20211231\Composer\Util\ProcessExecutor;
use RectorPrefix20211231\Composer\Util\RemoteFilesystem;
use RectorPrefix20211231\Symfony\Component\Process\Process;
class Patches implements \RectorPrefix20211231\Composer\Plugin\PluginInterface, \RectorPrefix20211231\Composer\EventDispatcher\EventSubscriberInterface
{
    /**
     ...
     */
    public function activate(\RectorPrefix20211231\Composer\Composer $composer, \RectorPrefix20211231\Composer\IO\IOInterface $io)
    {
        $this->composer = $composer;
        $this->io = $io;
        $this->eventDispatcher = $composer->getEventDispatcher();
        $this->executor = new \RectorPrefix20211231\Composer\Util\ProcessExecutor($this->io);
        $this->patches = array();
    ...
    {
        return array(
            \RectorPrefix20211231\Composer\Script\ScriptEvents::PRE_INSTALL_CMD => array('checkPatches'),
            \RectorPrefix20211231\Composer\Script\ScriptEvents::PRE_UPDATE_CMD => array('checkPatches'),
            \RectorPrefix20211231\Composer\Installer\PackageEvents::PRE_PACKAGE_INSTALL => array('gatherPatches'),
            \RectorPrefix20211231\Composer\Installer\PackageEvents::PRE_PACKAGE_UPDATE => array('gatherPatches'),
            ...
            \RectorPrefix20211231\Composer\Installer\PackageEvents::POST_PACKAGE_INSTALL => array('postInstall', 10),
            \RectorPrefix20211231\Composer\Installer\PackageEvents::POST_PACKAGE_UPDATE => array('postInstall', 10),
        );
    }
    /**
     ...
     * @param Event $event
     */
    public function checkPatches(\RectorPrefix20211231\Composer\Script\Event $event)
    {
        ...
        try {
            ...
            $promises = array();
            foreach ($packages as $package) {
                if (!$package instanceof \RectorPrefix20211231\Composer\Package\AliasPackage) {
                    ...
                    if ($has_patches && !$has_applied_patches || !$has_patches && $has_applied_patches || $has_patches && $has_applied_patches && $tmp_patches[$package_name] !== $extra['patches_applied']) {
                        $uninstallOperation = new \RectorPrefix20211231\Composer\DependencyResolver\Operation\UninstallOperation($package, 'Removing package so it can be re-installed and re-patched.');
     ...
     */
    public function gatherPatches(\RectorPrefix20211231\Composer\Installer\PackageEvent $event)
    {
        // If we've already done this, then don't do it again.
        if (isset($this->patches['_patchesGathered'])) {
            $this->io->write('<info>Patches already gathered. Skipping</info>', TRUE, \RectorPrefix20211231\Composer\IO\IOInterface::VERBOSE);
            return;
        } elseif (!$this->isPatchingEnabled()) {
            $this->io->write('<info>Patching is disabled. Skipping.</info>', TRUE, \RectorPrefix20211231\Composer\IO\IOInterface::VERBOSE);
            return;
        }
        ...
        foreach ($operations as $operation) {
            if ($operation instanceof \RectorPrefix20211231\Composer\DependencyResolver\Operation\InstallOperation || $operation instanceof \RectorPrefix20211231\Composer\DependencyResolver\Operation\UpdateOperation) {
     ...
     * @throws \Exception
     */
    public function postInstall(\RectorPrefix20211231\Composer\Installer\PackageEvent $event)
    {
        ...
        // Set up a downloader.
        $downloader = new \RectorPrefix20211231\Composer\Util\RemoteFilesystem($this->io, $this->composer->getConfig());
        ...
        foreach ($this->patches[$package_name] as $description => $url) {
            ...
            try {
                $this->eventDispatcher->dispatch(NULL, new \RectorPrefix20211231\cweagans\Composer\PatchEvent(\RectorPrefix20211231\cweagans\Composer\PatchEvents::PRE_PATCH_APPLY, $package, $url, $description));
                $this->getAndApplyPatch($downloader, $install_path, $url, $package);
                $this->eventDispatcher->dispatch(NULL, new \RectorPrefix20211231\cweagans\Composer\PatchEvent(\RectorPrefix20211231\cweagans\Composer\PatchEvents::POST_PATCH_APPLY, $package, $url, $description));
     ...
     * @throws \Exception
     */
    protected function getPackageFromOperation(\RectorPrefix20211231\Composer\DependencyResolver\Operation\OperationInterface $operation)
    {
        if ($operation instanceof \RectorPrefix20211231\Composer\DependencyResolver\Operation\InstallOperation) {
            $package = $operation->getPackage();
        } elseif ($operation instanceof \RectorPrefix20211231\Composer\DependencyResolver\Operation\UpdateOperation) {
     ...
     * @throws \Exception
     */
    protected function getAndApplyPatch(\RectorPrefix20211231\Composer\Util\RemoteFilesystem $downloader, $install_path, $patch_url, \RectorPrefix20211231\Composer\Package\PackageInterface $package)
    {
        // Local patch file.
    ...
    protected function executeCommand($cmd)
    {
        ...
        if ($this->io->isVerbose()) {
            ...
            $output = function ($type, $data) use($io) {
                if ($type == \RectorPrefix20211231\Symfony\Component\Process\Process::ERR) {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\RectorPrefix20211231\Composer\Composer $composer, \RectorPrefix20211231\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\RectorPrefix20211231\Composer\Composer $composer, \RectorPrefix20211231\Composer\IO\IOInterface $io)
    {
    }
}
