 ...
 */
class Decoder extends \RectorPrefix20211231\Evenement\EventEmitter implements \RectorPrefix20211231\React\Stream\ReadableStreamInterface
{
    private $input;
    private $assoc;
    private $depth;
     ...
     */
    public function __construct(\RectorPrefix20211231\React\Stream\ReadableStreamInterface $input, $assoc = \false, $depth = 512, $options = 0, $maxlength = 65536)
    {
    ...
    {
        \RectorPrefix20211231\React\Stream\Util::pipe($this, $dest, $options);
        return $dest;
    }
    /** @internal */
