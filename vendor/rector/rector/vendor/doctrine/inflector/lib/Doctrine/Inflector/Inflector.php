...
class Inflector
{
    ...
    /** @var WordInflector */
    private $pluralizer;
    public function __construct(\RectorPrefix20211231\Doctrine\Inflector\WordInflector $singularizer, \RectorPrefix20211231\Doctrine\Inflector\WordInflector $pluralizer)
    {
    ...
    public function urlize(string $string) : string
    {
        ...
        $replacements = ['/\\W/' => ' ', '/([A-Z]+)([A-Z][a-z])/' => 'RectorPrefix20211231\\1_\\2', '/([a-z\\d])([A-Z])/' => 'RectorPrefix20211231\\1_\\2', '/[^A-Z^a-z^0-9^\\/]+/' => '-'];
        $urlized = $lowered;
