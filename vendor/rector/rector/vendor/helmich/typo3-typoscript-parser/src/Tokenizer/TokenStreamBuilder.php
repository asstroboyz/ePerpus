...
class TokenStreamBuilder
{
    ...
    public function append(string $type, string $value, int $line, array $patternMatches = []) : void
    {
        ...
        $this->tokens->append(new \RectorPrefix20211231\Helmich\TypoScriptParser\Tokenizer\Token($type, $value, $line, $this->currentColumn, $patternMatches));
     ...
     * @return void
     */
    public function appendToken(\RectorPrefix20211231\Helmich\TypoScriptParser\Tokenizer\TokenInterface $token) : void
    {
