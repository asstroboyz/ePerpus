...
use RectorPrefix20211231\Helmich\TypoScriptParser\Tokenizer\Token;
...
class TokenStream implements \Iterator, \ArrayAccess
{
     ...
     */
    public function current(int $lookAhead = 0) : \RectorPrefix20211231\Helmich\TypoScriptParser\Tokenizer\TokenInterface
    {
     ...
     * @return TokenInterface
     */
    public function offsetGet($offset) : \RectorPrefix20211231\Helmich\TypoScriptParser\Tokenizer\TokenInterface
    {
     ...
     * @return TokenStream
     */
    public function normalized() : \RectorPrefix20211231\Helmich\TypoScriptParser\Parser\TokenStream
    {
        $filteredTokens = [];
        $maxLine = 0;
        foreach ($this->tokens as $token) {
            ...
            if ($token->getType() === \RectorPrefix20211231\Helmich\TypoScriptParser\Tokenizer\TokenInterface::TYPE_WHITESPACE) {
                $value = \trim($token->getValue(), "\t ");
                if (\strlen($value) > 0) {
                    $filteredTokens[] = new \RectorPrefix20211231\Helmich\TypoScriptParser\Tokenizer\Token(\RectorPrefix20211231\Helmich\TypoScriptParser\Tokenizer\TokenInterface::TYPE_WHITESPACE, $value, $token->getLine(), $token->getColumn());
                }
            } else {
        ...
        $filteredTokens[] = new \RectorPrefix20211231\Helmich\TypoScriptParser\Tokenizer\Token(\RectorPrefix20211231\Helmich\TypoScriptParser\Tokenizer\TokenInterface::TYPE_WHITESPACE, "\n", $maxLine + 1, 1);
        $filteredTokens[] = new \RectorPrefix20211231\Helmich\TypoScriptParser\Tokenizer\Token(\RectorPrefix20211231\Helmich\TypoScriptParser\Tokenizer\TokenInterface::TYPE_WHITESPACE, "\n", $maxLine + 2, 1);
        return new \RectorPrefix20211231\Helmich\TypoScriptParser\Parser\TokenStream($filteredTokens);
    }
}
