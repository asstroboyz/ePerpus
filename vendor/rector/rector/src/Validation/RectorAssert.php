...
use RectorPrefix20211231\Webmozart\Assert\InvalidArgumentException;
/**
...
final class RectorAssert
{
    ...
    public static function className(string $className) : void
    {
        ...
        throw new \RectorPrefix20211231\Webmozart\Assert\InvalidArgumentException($errorMessage);
    }
}
