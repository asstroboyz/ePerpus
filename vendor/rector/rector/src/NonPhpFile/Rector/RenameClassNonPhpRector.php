...
, ['SomeOldClass' => 'SomeNewClass'])]);
    ...
    public function configure(array $configuration) : void
    {
        ...
        \RectorPrefix20211231\Webmozart\Assert\Assert::isArray($renameClasses);
        \RectorPrefix20211231\Webmozart\Assert\Assert::allString(\array_keys($renameClasses));
        \RectorPrefix20211231\Webmozart\Assert\Assert::allString($renameClasses);
    ...
    private function renameClasses(string $newContent, array $classRenames) : string
    {
        ...
        foreach ($classRenames as $oldClass => $newClass) {
            ...
            $newContent = \RectorPrefix20211231\Nette\Utils\Strings::replace($newContent, $oldClassRegex, function (array $match) use($newClass) : string {
