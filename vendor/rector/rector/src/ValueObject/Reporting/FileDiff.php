...
final class FileDiff implements \RectorPrefix20211231\Symplify\EasyParallel\Contract\SerializableInterface
{
    /**
     * @var string
    ...
    public function __construct(string $relativeFilePath, string $diff, string $diffConsoleFormatted, array $rectorsWithLineChanges = [])
    {
        ...
        \RectorPrefix20211231\Webmozart\Assert\Assert::allIsAOf($rectorsWithLineChanges, \Rector\ChangesReporting\ValueObject\RectorWithLineChange::class);
    }
    ...
    {
        $match = \RectorPrefix20211231\Nette\Utils\Strings::match($this->diff, self::FIRST_LINE_REGEX);
