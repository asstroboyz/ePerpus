...
final class InitCommand extends \RectorPrefix20211231\Symfony\Component\Console\Command\Command
{
    /**
     * @readonly
    ...
    protected function configure() : void
    {
        ...
        $this->addOption(\Rector\Core\Configuration\Option::TEMPLATE_TYPE, null, \RectorPrefix20211231\Symfony\Component\Console\Input\InputOption::VALUE_OPTIONAL, 'A template type like default, nette, doctrine etc.', \Rector\Core\Template\DefaultResolver::TYPE);
    }
    protected function execute(\RectorPrefix20211231\Symfony\Component\Console\Input\InputInterface $input, \RectorPrefix20211231\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        if ($doesFileExist) {
            ...
            $phpVersion = \RectorPrefix20211231\Nette\Utils\Strings::substring($fullPHPVersion, 0, 1) . \RectorPrefix20211231\Nette\Utils\Strings::substring($fullPHPVersion, 2, 1);
