        ...
        <div class="col-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    ...
                    <a href="/Admin/tambahRestok" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Restok</a>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="/Admin/detailRestok/<?= $restok['restok_id']; ?>"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form
                                                    action="/Admin/deleteRestok/<?= $restok['restok_id']; ?>"
                                                    method="post">
                                                    <?= csrf_field() ?>
