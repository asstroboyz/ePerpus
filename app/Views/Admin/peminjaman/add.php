        ...
        <?php $session = session() ?>
            ...
            <div class="mb-3">
                ...
                <input class="form-control " id="nomor" name="nomor" type="text"
                    oninvalid="this.setCustomValidity('Nomor Buku harus diisi Tidak Boleh Kosong')"
                    oninput="this.setCustomValidity('')">
            </div>
            <div class="mb-3">
                <label for="exampleFormControlInput1">Pilih Buku</label>
                <select
                    class="form-control selectpicker <?= $session->getFlashdata('pesan_pinjam') ? 'is-invalid' : ''; ?>"
                    id="buku" name="buku" oninvalid="this.setCustomValidity('Buku Tidak Boleh Kosong')"
                    oninput="this.setCustomValidity('')" required data-live-search="true">
            ...
            <div class="mb-3">
                ...
                <select class="form-control selectpicker" data-live-search="true" id="siswa" name="siswa"
                    oninvalid="this.setCustomValidity('Siswa Tidak Boleh Kosong')" oninput="this.setCustomValidity('')"
                    required>
            ...
            <div class="mb-3">
                ...
                <input
                    ...
                    oninvalid="this.setCustomValidity('Tanggal Pinjam harus diisi Tidak Boleh Kosong')"
                    oninput="this.setCustomValidity('')">
            </div>
            <div class="mb-3">
                ...
                <input
                    class="form-control <?= $session->getFlashdata('pesan_error_kd_rusak') ? 'is-invalid' : ''; ?>"
                    id="tanggal_kembali" name="tanggal_kembali" type="date"
                    oninvalid="this.setCustomValidity('Tanggal Kembali harus diisi Tidak Boleh Kosong')"
            ...
            <div class="mb-3">
                ...
                <select class="form-control" id="kondisi_buku" name="kondisi_buku"
                    oninvalid="this.setCustomValidity('Kondisi_BukuTidak Boleh Kosong')"
                    oninput="this.setCustomValidity('')" required>
                    <option value="">--Pilih Kondisi Buku--</option>
                    <option value="Baik" <?= old('baik') === 'baik' ? 'selected' : ''; ?>>Baik
                    </option>
                    <option value="Rusak" <?= old('rusak') === 'rusak' ? 'selected' : ''; ?>>Rusak
                    </option>
                </select>
            </div>
