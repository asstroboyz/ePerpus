...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            -->
            <!-- <form action="<?= base_url('Admin/updateBalita/' . $balita['id']); ?>"
            method="post"> -->
            <form
                action="<?= base_url('/Admin/updateBalita/' . $balita['id']) ?>"
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="posyandu_id" name="posyandu_id" required>
                        ...
                        <option
                            value="<?= $p['id']; ?>"
                            <?= old('posyandu_id', $balita['posyandu_id']) == $p['id'] ? 'selected' : ''; ?>><?= $p['nama_posyandu']; ?>
                        </option>
                        <?php endforeach; ?>
                    </select>
                </div>
