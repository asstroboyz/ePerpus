    ...
    ?>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-warning btn-block btn-bayar"
                                            data-toggle="modal"
                                            data-target="#modalBayar<?= $piutang['id_piutang']; ?>">
                                    ...
                                    <div class="modal fade"
                                        id="modalBayar<?= $piutang['id_piutang']; ?>"
                                        tabindex="-1" role="dialog"
                                        aria-labelledby="modalBayarLabel<?= $piutang['id_piutang']; ?>"
                                        aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title"
                                                        id="modalBayarLabel<?= $piutang['id_piutang']; ?>">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="/Admin/bayarPiutang/<?= $piutang['id_piutang']; ?>"
...
<div class="modal fade" id="modalTambahPiutang" tabindex="-1" role="dialog" aria-labelledby="modalTambahPiutangLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                ...
                <form action="/Admin/savePiutang" method="post">
                    <?=csrf_field()?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="jumlah_piutang" name="jumlah_piutang"
                    ...
                    <div class="form-group">
                        <label for="id_supplier">Nama Pelanggan</label>
