...
<head>
    <title>Laporan Barang ATK Masuk</title>
    <style>
    body {
        text-align: center;
    ...
    <div class="container">
            ...
            <tr>
                ...
                <td style="text-align: center;">
                    <div class="header-content">
                        ...
                        <p class="kop" style="font-size: 16px; margin: 0;"></p>
                    </div>
                </td>
            </tr>
        </table>
        ...
        <div style="text-align: left;">
            <p>
                ...
                DAFTAR BARANG ATK MASUK BADAN PUSAT STATISTIK KOTA PEKALONGAN
            </p>
        ...
        <table class="custom-table">
            <thead>
                <tr>
                    ...
                    <th style="width: 55%;">Merk Barang</th>
                    <th style="width: 15%;">Tanggal Barang Masuk</th>
                    <th style="width: 15%;">Jumlah Barang Masuk</th>
                </tr>
            </thead>
            <tbody>
