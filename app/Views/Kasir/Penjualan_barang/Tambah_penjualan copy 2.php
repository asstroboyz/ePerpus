...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-900">Form Tambah Penjualan Barang</h1>
                                ...
                                <div class="row mx-0">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <label for="metode_pembayaran">Nama Pelanggan</label>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                    <div class="row mx-0">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label for="stok">Stok Yang Tersedia</label>
                                                <input type="text" id="stok" class="form-control stok" readonly
                                                    value="<?= $selectedProduk['stok'] ?? '' ?>">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label for="harga_jual">Harga </label>
                                                <input type="hidden" name="harga_jual_raw_2" id="harga_jual_raw_2"
                                                    value="<?= $selectedProduk['harga_jual'] ?? '' ?>">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="jumlah[]" id="jumlah"
                                                    class="form-control jumlah" autofocus required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
