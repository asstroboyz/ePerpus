        ...
        <div class="col-12">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <a href="/Pegawai/list_permintaan/<?= $detail['id_permintaan_barang']; ?>" class=" btn ml-n3 text-primary font-weight-bold "><i class="fas fa-chevron-left"></i> Kembali ke
                        daftar permintaan</a>
                    ...
                    <a href="<?php echo base_url('Pegawai/ekspor/' . $detail['id']); ?>" class="text-light btn btn-success font-weight-bold float-right" target="blank"><i class="fa fa-print"></i> print</a>
                </div>
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-1 d-none d-md-block">:</div>
                        <div class="col-md-8">
                            <?= $detail['jumlah'] ?> <?= $detail['nama_satuan'] ?>
                        </div>
                    </div>
