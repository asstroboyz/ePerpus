        ...
        <div class="col-12">
            ...
            <div class="card shadow">
                <div class="card-header">
                    <a href="/Kasir/master_barang">&laquo; Kembali ke daftar barang barang</a>
                </div>
                <div class="card-body">
                    <form
                        action="/Kasir/editMaster/<?= $master_brg['kode_brg']; ?>  "
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="jenis_brg"
                                        ...
                                        <option value="obat" <?= $master_brg['jenis_brg'] == 'obat' ? 'selected' : ''; ?>>Obat
                                        </option>
                                        <option value="bahan_pokok" <?= $master_brg['jenis_brg'] == 'bahan_pokok' ? 'selected' : ''; ?>>Bahan
                                            Pokok</option>
                                        <option value="atk" <?= $master_brg['jenis_brg'] == 'atk' ? 'selected' : ''; ?>>ATK
                                        </option>
                                        <option value="sabun_mandi" <?= $master_brg['jenis_brg'] == 'sabun_mandi' ? 'selected' : ''; ?>>Sabun
                                            Mandi</option>
                                        <option value="sabun_baju" <?= $master_brg['jenis_brg'] == 'sabun_baju' ? 'selected' : ''; ?>>Sabun
                                            Baju</option>
                                        <option value="minuman" <?= $master_brg['jenis_brg'] == 'minuman' ? 'selected' : ''; ?>>Minuman
                                        </option>
                                        <option value="snack" <?= $master_brg['jenis_brg'] == 'snack' ? 'selected' : ''; ?>>Snack
                                        </option>
                                        <option value="gas" <?= $master_brg['jenis_brg'] == 'gas' ? 'selected' : ''; ?>>Gas
                                        </option>
                                        <option value="galon" <?= $master_brg['jenis_brg'] == 'galon' ? 'selected' : ''; ?>>Galon
                                        </option>
                                    </select>
                                </div>
