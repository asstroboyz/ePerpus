        ...
        <div class="col-12">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <!-- <h3>Modal Toko</h3> -->
                    <a href="/Kasir/tambahModal" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Modal
                        Toko</a>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        <a href="/Kasir/editModal/<?= $modal['id_modal']; ?>"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="/Kasir/deleteModal/<?= $modal['id_modal']; ?>"
