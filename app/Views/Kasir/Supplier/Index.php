        ...
        <div class="col-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    ...
                    <a href="/Kasir/tambahSupplier" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah
                        Supplier</a>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-bordered table-lg" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="/Kasir/editSupplier/<?= $supplier['id_supplier']; ?>"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form
                                                    action="/Kasir/deleteSupplier/<?= $supplier['id_supplier']; ?>"
                                                    method="post">
                                                    <?= csrf_field() ?>
