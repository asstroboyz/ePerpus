        ...
        <div class="col-12">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h3>Daftar Barang </h3>
                    <a href="tambahProduk" class="btn btn-primary">
                        <i class="fa fa-plus"></i> Tambah Barang
                    </a>

                    <a href="<?php echo base_url('Admin/atk_trash/'); ?>"
                        ...
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <?php foreach ($barangs as $num => $data) {
                                    $transaksiKeluar = $transaksiModel->where('kode_brg', $data['kode_brg'])
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url("/Admin/formTambahStok/{$data['kode_brg']}") ?>"
                                            class="btn btn-success btn-sm">
                                            <i class="fa fa-plus"></i> Tambah Stok
                                        </a>
                                        <a href="/Admin/formKurangStok/<?= $data['kode_brg'] ?>"
                                            class="btn btn-warning btn-sm">
                                            <i class="fa fa-minus"></i> Kurang Stok
                                        </a>
                                        <!-- <a href="<?= base_url("/Admin/softDelete/{$data['kode_brg']}") ?>"
