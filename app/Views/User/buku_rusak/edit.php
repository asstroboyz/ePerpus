...
<div class="card mb-4">
    <div class="card-header">
        <div class="row align-items-center">
            ...
            <div class="col-md-6">
                <a href="<?= base_url('databukurusak'); ?>" class="btn btn-sm btn-secondary float-end">
    ...
    <div class="card-body">
        ...
        <?php $session = session() ?>
        <form action="/updatedatabukurusak/<?= $bukurusak['kode_buku_rusak']; ?>" method="post">
            <div class="mb-3">
                ...
                <input
                    ...
                    value="<?= $bukurusak['kode_buku_rusak']; ?>"> <!-- Ubah di sini -->
            ...
            <div class="mb-3">
                ...
                <input class="form-control" id="jumlah_buku" name="jumlah_buku" type="number"
                    ...
                    oninput="this.setCustomValidity('')" required
                    value="<?= $bukurusak['jumlah_buku_rusak']; ?>"> <!-- Ubah di sini -->
            </div>
            <div class="mb-3">
