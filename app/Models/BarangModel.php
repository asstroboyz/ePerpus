...
class BarangModel extends Model
{
    ...
    protected $allowedFields = ['kode_barang', 'nama_brg','jenis_brg','merk', 'id_satuan', 'tanggal_barang_masuk',  'deleted_at', 'stok', 'harga_beli','harga_jual','created_at','id_supplier'];
